...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SHEER_FORCE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SHEER_FORCE, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities = { ABILITY_REFRIGERATE, ABILITY_SERENE_GRACE, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_PRANKSTER, ABILITY_PICKUP, ABILITY_MAGICIAN },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities = { ABILITY_FRISK, ABILITY_INFILTRATOR, ABILITY_AERIALATE },
        .bodyColor = BODY_COLOR_PURPLE,
