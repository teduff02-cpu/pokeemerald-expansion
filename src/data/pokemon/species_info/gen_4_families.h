...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .baseSpeed     = 100,
        .baseSpAttack  = 50,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 75 : 50,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 243,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_KRICKETUNE}),
    },
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_FUR_COAT, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_PUNK_ROCK, ABILITY_BIG_PECKS },
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SNIPER, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
